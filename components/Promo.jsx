  ...
  return (
    <div className="bg-[#2C2D33]">
      <div className="max-w-[1050px] w-full mx-auto py-16 grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-8">
        <div className="col-span-1 md:col-span-4 border-t-8 md:border-t-0 md:border-l-8 border-blue-600 hover:border-blue-300 w-full px-8 py-12 bg-[url('../public/assets/promo_bg_1.jpg')] bg-cover flex ">
        ...
        <div className="md:col-span-2 border-l-8 border-blue-600 hover:border-blue-300 w-full px-8 pt-12 pb-8  bg-[url('../public/assets/promo_bg_2.jpg')] bg-cover">
        ...
        <div className="col-span-1 md:border-b-8 border-l-8 md:border-l-0 border-blue-600 hover:border-blue-300 w-full px-8 pt-12 pb-8 bg-[url('../public/assets/promo_bg_3.jpg')] bg-cover md:flex flex-col items-center">
          <div className="bg-white/70 mb-8 text-blue-500 flex items-center justify-center w-[100px] h-[100px]">
        ...
        <div className="col-span-1 md:border-b-8 border-l-8 md:border-l-0 border-blue-600 hover:border-blue-300 w-full px-8 pt-12 pb-8 bg-[url('../public/assets/promo_bg_4.jpg')] bg-cover md:flex flex-col items-center">
          <div className="bg-white/70 mb-8 text-blue-500 flex items-center justify-center w-[100px] h-[100px]">
            <BiBriefcase size={50} />
          </div>
